...
# def cluster_articles(input_path=None, output_path="data/clustered/clustered_articles.csv", n_clusters=5):
#     if not input_path:
#         # Use latest scrape if none given
...
#     with mlflow.start_run(run_name="daily_cluster_run"):
#         mlflow.log_param("embedding_model", "all-MiniLM-L6-v2")
#         mlflow.log_param("clustering_algo", "KMeans")
...
def cluster_articles(
    ...
    if valid_clusters >= 2:
        ...
        print("\n⚠️ Not enough clusters to compute metrics.")
